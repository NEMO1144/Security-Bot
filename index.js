...
calli.on("ready", () => {
  ...
  calli.user.setActivity(`${prefix}help | SUBSCRIBE NEMO ON YOUTUBE`, {
    Type: "Playing"
  });
});
///////////////////////////////////////////////////////////////////////////////
...
**Links**
[Support](https://discord.com/invite/5YcPk2gm7u) - [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot) 
